...
| --- | --- | ---: | --- | --- | --- |
| sparsity | `results/raw/sparsity.csv` | 18000 | `k` | OMP, gOMP, Improved-gOMP | baseline, optimized |
| snr | `results/raw/snr.csv` | 19200 | `snr_db` | OMP, gOMP, Improved-gOMP, RMP | baseline, optimized |
| runtime | `results/raw/runtime.csv` | 9600 | `n` | OMP, gOMP, Improved-gOMP, RMP | baseline, optimized |
| compression | `results/raw/compression.csv` | 19200 | `measurement_ratio` | OMP, gOMP, Improved-gOMP, RMP | baseline, optimized |
| matrix_type | `results/raw/matrix_type.csv` | 5400 | `matrix_kind` | OMP, gOMP, Improved-gOMP | baseline, optimized |
| coeff_mode | `results/raw/coeff_mode.csv` | 5400 | `coeff_mode` | OMP, gOMP, Improved-gOMP | baseline, optimized |
| ablation | `results/raw/ablation.csv` | 2400 | `ablation_variant` | 8 module-combination variants | optimized |
| param_sensitivity | `results/raw/param_sensitivity.csv` | 3000 | `screening_ratio`, `group_size` | Improved-gOMP | optimized |
...
`docs/experiment_figure_index.md`. Every figure used in the thesis, including
appendix figures, should trace back to a CSV source in `results/`.
